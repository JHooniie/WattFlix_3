		...
		<div id="Container">
			...
			<div class="toolbar">
				...
				<div class="searchbarContainer">
					...
					<label> <i class="fa-solid fa-magnifying-glass"></i></label> <input
						type="text" placeholder="마이 무비를 찾아보세요">
				</div>
			</div>
			<!-- toolbar -->
			<!-- 중간 타이틀 -->
			...
			<div id="bookmarkContainer">
				<ol class="movieList">
					<li class="movieItem rcBtn"><a href="#">
					...
					<c:forEach items="${ myMovieList}" var="like">
						...
						<div class="card movie marked">
							<img src="<c:url value='${like.moviePoster }'/>" width="220"
								height="320">
							<div class="inner-content">
								<div class="movie-info-title">
									<a
										href="<c:url value='/mymovie/deleteMymovie/${like.myMovieNo}'/>">
